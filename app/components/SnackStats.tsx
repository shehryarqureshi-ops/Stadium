      ...
      <div className="mx-auto flex w-full max-w-content flex-col items-center gap-10">
        ...
        <div data-animation="reveal" className="grid w-full grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="relative min-h-[22.25rem] overflow-hidden rounded-[1.5rem] border border-[#f5f5f5]">
            <Image src={statsPhoto} alt="A SnackMagic box delivered to a doorstep — 19.7M+ snacks delivered" fill className="object-cover" sizes="(min-width:1024px) 25rem, (min-width:768px) 45vw, 92vw" />
          </div>
          ...
          <div className="flex min-h-[22.25rem] flex-col justify-between gap-6 rounded-[1.5rem] bg-[#eaf1fd] p-6 text-[#16171b]">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex items-center gap-3">
                <Image src={avatar} alt="" width={54} height={54} className="size-[2.7rem] rounded-full object-cover" />
