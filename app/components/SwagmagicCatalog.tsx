...
/* /swag · THE CATALOG (Figma n9SjmDjzB1PeZAYJ5w43fr → 2500:5027 "Catalog",
   1440 wide, abs y 3837..4584). "25,000+ products. Hundreds of brands. One
   catalog." — left-aligned header, then a horizontal carousel of 10 category
   cards (348×460, r24) with prev/next arrow buttons bottom-right. Each card is
   a product flat-lay photo (the light grey studio ground is part of the photo)
   with REAL TEXT overlaid top-left: "7,000 ITEMS" eyebrow + Satoshi title in
   #181818. Photos are Figma's ORIGINAL uploads (1792–2098 px wide, ≈ 5× the
   348 css width) saved as JPEG q90; Figma's fill mode is cover anchored at the
   top-left, reproduced with object-cover + object-left-top.

   Figma stack (section frame is content-tight; y = offset inside 2500:5027,
   x = 100 → site content edge 120):
     header frame                   y=0    h=170 (gap 24 inside)
       eyebrow "THE CATALOG"        y=0    h=15  (12 Overpass SemiBold, lh normal = 15 → 1.25,
                                                  tracking 0.72 → 0.045rem, #218554)
       gap 8
       title 44/1.08 Satoshi Bold   y=23   h=96  (2 lines, tracking -0.5, #16171b)
       gap 24
       subhead 18/1.48 #6b6c71      y=143  h=27
     gap 45
     carousel                        y=215  h=532 (gap 32 inside)
   ...
   Neighbouring frames are contiguous with content-tight edges → white section
   py 80/80 (lg:py-20) so the visible gap to neighbours is 160. */

import { useEffect, useRef, useState } from "react";
import Image, { type StaticImageData } from "next/image";
import apparel from "@/public/swag2/sw2-catalog-apparel.jpg";
import drinkware from "@/public/swag2/sw2-catalog-drinkware.jpg";
import bags from "@/public/swag2/sw2-catalog-bags.jpg";
import office from "@/public/swag2/sw2-catalog-office.jpg";
import technology from "@/public/swag2/sw2-catalog-technology.jpg";
import events from "@/public/swag2/sw2-catalog-events.jpg";
import health from "@/public/swag2/sw2-catalog-health.jpg";
import outdoor from "@/public/swag2/sw2-catalog-outdoor.jpg";
import auto from "@/public/swag2/sw2-catalog-auto.jpg";
import baby from "@/public/swag2/sw2-catalog-baby.jpg";

type Card = { img: StaticImageData; count: string; label: string };

/* Copy exactly as in Figma 2500:5034 — cards 4–10 carry the "0,000 ITEMS"
...
function Arrow({ dir, disabled, onClick }: { dir: "l" | "r"; disabled: boolean; onClick: () => void }) {
  return (
    ...
    >
      {/* lucide/arrow-left · lucide/arrow-right — paths from Figma svgAssets (2500:5077 / 2500:5080) */}
          ...
          >
            {CARDS.map((c) => (
              ...
              >
                ...
                />
                <div className="absolute left-6 top-6 flex flex-col gap-1 text-ink">
