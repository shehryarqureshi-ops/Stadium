...
const EXPERIENCES: Experience[] = [
  ...
  {
    tab: "in-person",
    title: "Museum Storytelling Tour",
    slug: "museum-storytelling-tour",
    format: "in-person",
    minutes: "60",
    capacity: "max 495",
  },
  ...
  {
    tab: "hybrid",
    title: "Live Aquarium Tour",
    slug: "live-aquarium-tour",
    format: "hybrid",
    minutes: "60",
    capacity: "max 350",
  },
  {
    tab: "hybrid",
    title: "Winter Mixology Class",
    slug: "winter-mixology-class",
    format: "hybrid",
    minutes: "30-60",
    capacity: "max 495",
  },
  ...
  {
    tab: "hybrid",
    title: "BYO Fall Mixology Class",
    slug: "byo-fall-mixology-class",
    format: "hybrid",
    minutes: "60",
    capacity: "max 495",
  },
  ...
  {
    tab: "under-60",
    title: "Speed Leader of the Pack",
    slug: "speed-leader-of-the-pack",
    format: "virtual",
    minutes: "30",
    capacity: "2-80",
  },
  ...
  {
    tab: "under-60",
    title: "Buzzer Beater Trivia",
    slug: "buzzer-beater-trivia",
    format: "virtual",
    minutes: "15",
    capacity: "2-500",
  },
  ...
  {
    tab: "under-60",
    title: "Buzzer Beater Wednesday",
    slug: "buzzer-beater-wednesday",
    format: "virtual",
    minutes: "15",
    capacity: "2-500",
  },
  ...
  },
  {
    ...
    slug: "totem-strength-recognition",
    format: "virtual",
    minutes: "60",
    capacity: "4-95",
  },
  ...
  {
    tab: "small-groups",
    title: "Mini Murder Mystery",
    slug: "mini-murder-mystery",
    format: "virtual",
    minutes: "75",
    capacity: "max 27",
  },
  ...
  {
    tab: "big-groups",
    title: "Sher-Locked Escape Quest",
    slug: "sher-locked-escape-quest",
    format: "virtual",
    minutes: "75-90",
    capacity: "max 500",
  },
...
export default function ExpSolution() {
  ...
  return (
    <section className="bg-white px-section-x-sm md:px-section-x-md lg:px-section-x-lg min-w-0">
