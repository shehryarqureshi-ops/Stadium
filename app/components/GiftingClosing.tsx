  ...
  return (
    ...
    >
      <section
        ...
        className="relative px-section-x-sm md:px-section-x-md lg:px-section-x-lg"
      >
              ...
              <div className="flex flex-1 flex-col justify-between gap-6">
                ...
                <figure className="flex flex-col gap-4">
                  <blockquote className="max-w-[18.375rem] font-sans text-[1.0625rem] leading-[1.4] lg:text-[1.125rem]">
                    “People loved being able to choose their own gift. It
                    eliminated the guesswork for me!”
                  </blockquote>
                  <figcaption className="flex items-center gap-2">
                    ...
                    <span className="flex min-w-0 flex-1 flex-col text-[0.75rem] leading-[1.4]">
                      <span className="font-sans font-medium text-[#16171b]">
                        Charlene S.
                      </span>
                      <span className="font-sans text-[#5b6071]">
                        The Standard
                      </span>
                    </span>
                  </figcaption>
      ...
      >
        <div className="mx-auto w-full max-w-content">
          ...
          >
            ...
            >
              Book a call to explore pricing, catalog options, and the right
              setup for your team.
            </p>
            <div
              data-animation="reveal"
            ...
            >
              <a
                href="#"
                className={`${PILL} bg-[#ffb800] text-[#1b1b1b] hover:bg-[#ffc42b] hover:brightness-105`}
              >
                <span className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both]">
                  TALK TO SALES
                </span>
