/* /gifting · THE PROBLEM (Figma 1113:2249). A white card that peeks up over the
   dark hero (two stacked translucent "page" bars for depth), holding the
   "Every team gifts differently" header and a grey tray of three photo cards. */

import Image, { type StaticImageData } from "next/image";
import prob1 from "@/public/gifting/g2-problem-1.jpg";
import prob2 from "@/public/gifting/g2-problem-2.jpg";
import prob3 from "@/public/gifting/g2-problem-3.jpg";
...
export default function GiftProblem() {
  return (
    <section className="relative z-10 -mt-10 px-section-x-sm md:px-section-x-md lg:-mt-16 lg:px-section-x-lg">
      <div className="mx-auto flex w-full max-w-content flex-col items-center">
        ...
        <div aria-hidden className="h-3.5 w-[91.9%] rounded-t-[7px] bg-white/50" />
        <div aria-hidden className="h-[1.125rem] w-[96.1%] rounded-t-[10px] bg-white/75" />
        ...
        <div className="flex w-full flex-col items-center rounded-t-[1rem] bg-white px-6 pt-16 md:px-12 md:pt-20 lg:pt-24">
          <div className="flex max-w-[53.75rem] flex-col items-center gap-5 text-center">
            ...
            >
              Sales runs its own platform, HR defaults to gift cards, and Marketing
              uses an agency. Budgets, vendors, and reporting never line up.
            </p>
          </div>
